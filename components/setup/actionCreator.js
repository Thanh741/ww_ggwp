...
export const updatePlayerNumber = (playerNumber) => (dispatch, getState) => {
  dispatch({
...
export const updatePlayerNames  = (playerNames) => (dispatch, getState) => {
  dispatch({
...
export const updateRoles = (roles) => (dispatch, getState) => {
  dispatch({
